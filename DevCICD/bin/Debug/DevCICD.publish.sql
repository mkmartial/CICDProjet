/*
Script de déploiement pour TEST
...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL16.DELEVOP22\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL16.DELEVOP22\MSSQL\DATA\"
...
GO
PRINT N'Création de Schéma [HumanResources]...';
...
GO
PRINT N'Création de Schéma [Person]...';
...
GO
PRINT N'Création de Schéma [Production]...';
...
GO
PRINT N'Création de Catalogue de recherche en texte intégral [AW2016FullTextCatalog]...';
...
GO
PRINT N'Création de Collection de schémas XML [HumanResources].[HRResumeSchemaCollection]...';
...
GO
PRINT N'Création de Collection de schémas XML [Person].[IndividualSurveySchemaCollection]...';
...
GO
PRINT N'Création de Collection de schémas XML [Person].[AdditionalContactInfoSchemaCollection]...';
...
GO
PRINT N'Création de Collection de schémas XML [Production].[ProductDescriptionSchemaCollection]...';
...
GO
PRINT N'Création de Collection de schémas XML [Production].[ManuInstructionsSchemaCollection]...';
...
GO
PRINT N'Création de Collection de schémas XML [Sales].[StoreSurveySchemaCollection]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[AccountNumber]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[Flag]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[Name]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[NameStyle]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[OrderNumber]...';
...
GO
PRINT N'Création de Type de données défini par l''utilisateur [dbo].[Phone]...';
...
GO
PRINT N'Création de Table [HumanResources].[Shift]...';
...
GO
PRINT N'Création de Index [HumanResources].[Shift].[AK_Shift_Name]...';
...
GO
PRINT N'Création de Index [HumanResources].[Shift].[AK_Shift_StartTime_EndTime]...';
...
GO
PRINT N'Création de Table [HumanResources].[JobCandidate]...';
...
GO
PRINT N'Création de Index [HumanResources].[JobCandidate].[IX_JobCandidate_BusinessEntityID]...';
...
GO
PRINT N'Création de Table [HumanResources].[EmployeePayHistory]...';
...
GO
PRINT N'Création de Table [HumanResources].[EmployeeDepartmentHistory]...';
...
GO
PRINT N'Création de Index [HumanResources].[EmployeeDepartmentHistory].[IX_EmployeeDepartmentHistory_DepartmentID]...';
...
GO
PRINT N'Création de Index [HumanResources].[EmployeeDepartmentHistory].[IX_EmployeeDepartmentHistory_ShiftID]...';
...
GO
PRINT N'Création de Table [HumanResources].[Employee]...';
...
GO
PRINT N'Création de Index [HumanResources].[Employee].[AK_Employee_LoginID]...';
...
GO
PRINT N'Création de Index [HumanResources].[Employee].[AK_Employee_NationalIDNumber]...';
...
GO
PRINT N'Création de Index [HumanResources].[Employee].[AK_Employee_rowguid]...';
...
GO
PRINT N'Création de Index [HumanResources].[Employee].[IX_Employee_OrganizationLevel_OrganizationNode]...';
...
GO
PRINT N'Création de Index [HumanResources].[Employee].[IX_Employee_OrganizationNode]...';
...
GO
PRINT N'Création de Table [HumanResources].[Department]...';
...
GO
PRINT N'Création de Index [HumanResources].[Department].[AK_Department_Name]...';
...
GO
PRINT N'Création de Table [Person].[AddressType]...';
...
GO
PRINT N'Création de Index [Person].[AddressType].[AK_AddressType_Name]...';
...
GO
PRINT N'Création de Index [Person].[AddressType].[AK_AddressType_rowguid]...';
...
GO
PRINT N'Création de Table [Person].[Address]...';
...
GO
PRINT N'Création de Index [Person].[Address].[AK_Address_rowguid]...';
...
GO
PRINT N'Création de Index [Person].[Address].[IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode]...';
...
GO
PRINT N'Création de Index [Person].[Address].[IX_Address_StateProvinceID]...';
...
GO
PRINT N'Création de Table [Person].[StateProvince]...';
...
GO
PRINT N'Création de Index [Person].[StateProvince].[AK_StateProvince_Name]...';
...
GO
PRINT N'Création de Index [Person].[StateProvince].[AK_StateProvince_rowguid]...';
...
GO
PRINT N'Création de Index [Person].[StateProvince].[AK_StateProvince_StateProvinceCode_CountryRegionCode]...';
...
GO
PRINT N'Création de Table [Person].[PhoneNumberType]...';
...
GO
PRINT N'Création de Table [Person].[PersonPhone]...';
...
GO
PRINT N'Création de Index [Person].[PersonPhone].[IX_PersonPhone_PhoneNumber]...';
...
GO
PRINT N'Création de Table [Person].[Person]...';
...
GO
PRINT N'Création de Index [Person].[Person].[AK_Person_rowguid]...';
...
GO
PRINT N'Création de Index [Person].[Person].[IX_Person_LastName_FirstName_MiddleName]...';
...
GO
PRINT N'Création de Index XML [Person].[Person].[PXML_Person_AddContact]...';
...
GO
PRINT N'Création de Index XML [Person].[Person].[PXML_Person_Demographics]...';
...
GO
PRINT N'Création de Index XML [Person].[Person].[XMLPATH_Person_Demographics]...';
...
GO
PRINT N'Création de Index XML [Person].[Person].[XMLPROPERTY_Person_Demographics]...';
...
GO
PRINT N'Création de Index XML [Person].[Person].[XMLVALUE_Person_Demographics]...';
...
GO
PRINT N'Création de Table [Person].[Password]...';
...
GO
PRINT N'Création de Table [Person].[EmailAddress]...';
...
GO
PRINT N'Création de Index [Person].[EmailAddress].[IX_EmailAddress_EmailAddress]...';
...
GO
PRINT N'Création de Table [Person].[CountryRegion]...';
...
GO
PRINT N'Création de Index [Person].[CountryRegion].[AK_CountryRegion_Name]...';
...
GO
PRINT N'Création de Table [Person].[ContactType]...';
...
GO
PRINT N'Création de Index [Person].[ContactType].[AK_ContactType_Name]...';
...
GO
PRINT N'Création de Table [Person].[BusinessEntityContact]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityContact].[AK_BusinessEntityContact_rowguid]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityContact].[IX_BusinessEntityContact_ContactTypeID]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityContact].[IX_BusinessEntityContact_PersonID]...';
...
GO
PRINT N'Création de Table [Person].[BusinessEntityAddress]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityAddress].[AK_BusinessEntityAddress_rowguid]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityAddress].[IX_BusinessEntityAddress_AddressID]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntityAddress].[IX_BusinessEntityAddress_AddressTypeID]...';
...
GO
PRINT N'Création de Table [Person].[BusinessEntity]...';
...
GO
PRINT N'Création de Index [Person].[BusinessEntity].[AK_BusinessEntity_rowguid]...';
...
GO
PRINT N'Création de Table [Production].[ProductInventory]...';
...
GO
PRINT N'Création de Table [Production].[ProductDocument]...';
...
GO
PRINT N'Création de Table [Production].[ProductDescription]...';
...
GO
PRINT N'Création de Index [Production].[ProductDescription].[AK_ProductDescription_rowguid]...';
...
GO
PRINT N'Création de Table [Production].[ProductCostHistory]...';
...
GO
PRINT N'Création de Table [Production].[ProductCategory]...';
...
GO
PRINT N'Création de Index [Production].[ProductCategory].[AK_ProductCategory_Name]...';
...
GO
PRINT N'Création de Index [Production].[ProductCategory].[AK_ProductCategory_rowguid]...';
...
GO
PRINT N'Création de Table [Production].[Product]...';
...
GO
PRINT N'Création de Index [Production].[Product].[AK_Product_Name]...';
...
GO
PRINT N'Création de Index [Production].[Product].[AK_Product_ProductNumber]...';
...
GO
PRINT N'Création de Index [Production].[Product].[AK_Product_rowguid]...';
...
GO
PRINT N'Création de Table [Production].[Location]...';
...
GO
PRINT N'Création de Index [Production].[Location].[AK_Location_Name]...';
...
GO
PRINT N'Création de Table [Production].[Illustration]...';
...
GO
PRINT N'Création de Table [Production].[Document]...';
...
GO
PRINT N'Création de Index [Production].[Document].[AK_Document_DocumentLevel_DocumentNode]...';
...
GO
PRINT N'Création de Index [Production].[Document].[AK_Document_rowguid]...';
...
GO
PRINT N'Création de Index [Production].[Document].[IX_Document_FileName_Revision]...';
...
GO
PRINT N'Création de Table [Production].[Culture]...';
...
GO
PRINT N'Création de Index [Production].[Culture].[AK_Culture_Name]...';
...
GO
PRINT N'Création de Table [Production].[BillOfMaterials]...';
...
GO
PRINT N'Création de Index [Production].[BillOfMaterials].[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate]...';
...
GO
PRINT N'Création de Index [Production].[BillOfMaterials].[IX_BillOfMaterials_UnitMeasureCode]...';
...
GO
PRINT N'Création de Table [Production].[TransactionHistoryArchive]...';
...
GO
PRINT N'Création de Index [Production].[TransactionHistoryArchive].[IX_TransactionHistoryArchive_ProductID]...';
...
GO
PRINT N'Création de Index [Production].[TransactionHistoryArchive].[IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID]...';
...
GO
PRINT N'Création de Table [Production].[TransactionHistory]...';
...
GO
PRINT N'Création de Index [Production].[TransactionHistory].[IX_TransactionHistory_ProductID]...';
...
GO
PRINT N'Création de Index [Production].[TransactionHistory].[IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID]...';
...
GO
PRINT N'Création de Table [Production].[ScrapReason]...';
...
GO
PRINT N'Création de Index [Production].[ScrapReason].[AK_ScrapReason_Name]...';
...
GO
PRINT N'Création de Table [Production].[ProductSubcategory]...';
...
GO
PRINT N'Création de Index [Production].[ProductSubcategory].[AK_ProductSubcategory_Name]...';
...
GO
PRINT N'Création de Index [Production].[ProductSubcategory].[AK_ProductSubcategory_rowguid]...';
...
GO
PRINT N'Création de Table [Production].[ProductReview]...';
...
GO
PRINT N'Création de Index [Production].[ProductReview].[IX_ProductReview_ProductID_Name]...';
...
GO
PRINT N'Création de Table [Production].[ProductProductPhoto]...';
...
GO
PRINT N'Création de Table [Production].[ProductPhoto]...';
...
GO
PRINT N'Création de Table [Production].[ProductModelProductDescriptionCulture]...';
...
GO
PRINT N'Création de Table [Production].[ProductModelIllustration]...';
...
GO
PRINT N'Création de Table [Production].[ProductModel]...';
...
GO
PRINT N'Création de Index [Production].[ProductModel].[AK_ProductModel_Name]...';
...
GO
PRINT N'Création de Index [Production].[ProductModel].[AK_ProductModel_rowguid]...';
...
GO
PRINT N'Création de Index XML [Production].[ProductModel].[PXML_ProductModel_CatalogDescription]...';
...
GO
PRINT N'Création de Index XML [Production].[ProductModel].[PXML_ProductModel_Instructions]...';
...
GO
PRINT N'Création de Table [Production].[ProductListPriceHistory]...';
...
GO
PRINT N'Création de Table [Production].[WorkOrderRouting]...';
...
GO
PRINT N'Création de Index [Production].[WorkOrderRouting].[IX_WorkOrderRouting_ProductID]...';
...
GO
PRINT N'Création de Table [Production].[WorkOrder]...';
...
GO
PRINT N'Création de Index [Production].[WorkOrder].[IX_WorkOrder_ProductID]...';
...
GO
PRINT N'Création de Index [Production].[WorkOrder].[IX_WorkOrder_ScrapReasonID]...';
...
GO
PRINT N'Création de Table [Production].[UnitMeasure]...';
...
GO
PRINT N'Création de Index [Production].[UnitMeasure].[AK_UnitMeasure_Name]...';
...
GO
PRINT N'Création de Table [dbo].[AWBuildVersion]...';
...
GO
PRINT N'Création de Table [dbo].[DatabaseLog]...';
...
GO
PRINT N'Création de Table [dbo].[ErrorLog]...';
...
GO
PRINT N'Création de Table [Purchasing].[ProductVendor]...';
...
GO
PRINT N'Création de Index [Purchasing].[ProductVendor].[IX_ProductVendor_BusinessEntityID]...';
...
GO
PRINT N'Création de Index [Purchasing].[ProductVendor].[IX_ProductVendor_UnitMeasureCode]...';
...
GO
PRINT N'Création de Table [Purchasing].[PurchaseOrderDetail]...';
...
GO
PRINT N'Création de Index [Purchasing].[PurchaseOrderDetail].[IX_PurchaseOrderDetail_ProductID]...';
...
GO
PRINT N'Création de Table [Purchasing].[PurchaseOrderHeader]...';
...
GO
PRINT N'Création de Index [Purchasing].[PurchaseOrderHeader].[IX_PurchaseOrderHeader_EmployeeID]...';
...
GO
PRINT N'Création de Index [Purchasing].[PurchaseOrderHeader].[IX_PurchaseOrderHeader_VendorID]...';
...
GO
PRINT N'Création de Table [Purchasing].[ShipMethod]...';
...
GO
PRINT N'Création de Index [Purchasing].[ShipMethod].[AK_ShipMethod_Name]...';
...
GO
PRINT N'Création de Index [Purchasing].[ShipMethod].[AK_ShipMethod_rowguid]...';
...
GO
PRINT N'Création de Table [Purchasing].[Vendor]...';
...
GO
PRINT N'Création de Index [Purchasing].[Vendor].[AK_Vendor_AccountNumber]...';
...
GO
PRINT N'Création de Table [Sales].[CountryRegionCurrency]...';
...
GO
PRINT N'Création de Index [Sales].[CountryRegionCurrency].[IX_CountryRegionCurrency_CurrencyCode]...';
...
GO
PRINT N'Création de Table [Sales].[CreditCard]...';
...
GO
PRINT N'Création de Index [Sales].[CreditCard].[AK_CreditCard_CardNumber]...';
...
GO
PRINT N'Création de Table [Sales].[Currency]...';
...
GO
PRINT N'Création de Index [Sales].[Currency].[AK_Currency_Name]...';
...
GO
PRINT N'Création de Table [Sales].[CurrencyRate]...';
...
GO
PRINT N'Création de Index [Sales].[CurrencyRate].[AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode]...';
...
GO
PRINT N'Création de Table [Sales].[PersonCreditCard]...';
...
GO
PRINT N'Création de Table [Sales].[SalesOrderDetail]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderDetail].[AK_SalesOrderDetail_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderDetail].[IX_SalesOrderDetail_ProductID]...';
...
GO
PRINT N'Création de Table [Sales].[SalesOrderHeader]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderHeader].[AK_SalesOrderHeader_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderHeader].[AK_SalesOrderHeader_SalesOrderNumber]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderHeader].[IX_SalesOrderHeader_CustomerID]...';
...
GO
PRINT N'Création de Index [Sales].[SalesOrderHeader].[IX_SalesOrderHeader_SalesPersonID]...';
...
GO
PRINT N'Création de Table [Sales].[SalesOrderHeaderSalesReason]...';
...
GO
PRINT N'Création de Table [Sales].[SalesPerson]...';
...
GO
PRINT N'Création de Index [Sales].[SalesPerson].[AK_SalesPerson_rowguid]...';
...
GO
PRINT N'Création de Table [Sales].[SalesPersonQuotaHistory]...';
...
GO
PRINT N'Création de Index [Sales].[SalesPersonQuotaHistory].[AK_SalesPersonQuotaHistory_rowguid]...';
...
GO
PRINT N'Création de Table [Sales].[SalesReason]...';
...
GO
PRINT N'Création de Table [Sales].[SalesTaxRate]...';
...
GO
PRINT N'Création de Index [Sales].[SalesTaxRate].[AK_SalesTaxRate_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[SalesTaxRate].[AK_SalesTaxRate_StateProvinceID_TaxType]...';
...
GO
PRINT N'Création de Table [Sales].[SalesTerritory]...';
...
GO
PRINT N'Création de Index [Sales].[SalesTerritory].[AK_SalesTerritory_Name]...';
...
GO
PRINT N'Création de Index [Sales].[SalesTerritory].[AK_SalesTerritory_rowguid]...';
...
GO
PRINT N'Création de Table [Sales].[SalesTerritoryHistory]...';
...
GO
PRINT N'Création de Index [Sales].[SalesTerritoryHistory].[AK_SalesTerritoryHistory_rowguid]...';
...
GO
PRINT N'Création de Table [Sales].[ShoppingCartItem]...';
...
GO
PRINT N'Création de Index [Sales].[ShoppingCartItem].[IX_ShoppingCartItem_ShoppingCartID_ProductID]...';
...
GO
PRINT N'Création de Table [Sales].[SpecialOffer]...';
...
GO
PRINT N'Création de Index [Sales].[SpecialOffer].[AK_SpecialOffer_rowguid]...';
...
GO
PRINT N'Création de Table [Sales].[SpecialOfferProduct]...';
...
GO
PRINT N'Création de Index [Sales].[SpecialOfferProduct].[AK_SpecialOfferProduct_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[SpecialOfferProduct].[IX_SpecialOfferProduct_ProductID]...';
...
GO
PRINT N'Création de Table [Sales].[Store]...';
...
GO
PRINT N'Création de Index [Sales].[Store].[AK_Store_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[Store].[IX_Store_SalesPersonID]...';
...
GO
PRINT N'Création de Index XML [Sales].[Store].[PXML_Store_Demographics]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Shift_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_JobCandidate_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_EmployeePayHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_EmployeeDepartmentHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_SalariedFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_VacationHours]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_SickLeaveHours]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_CurrentFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Employee_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [HumanResources].[DF_Department_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_AddressType_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_AddressType_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Address_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Address_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_StateProvince_IsOnlyStateProvinceFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_StateProvince_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_StateProvince_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_PhoneNumberType_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_PersonPhone_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Person_NameStyle]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Person_EmailPromotion]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Person_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Person_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Password_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_Password_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_EmailAddress_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_EmailAddress_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_CountryRegion_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_ContactType_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntityContact_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntityContact_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntityAddress_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntityAddress_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntity_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Person].[DF_BusinessEntity_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductInventory_Quantity]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductInventory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductInventory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductDocument_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductDescription_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductDescription_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductCostHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductCategory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductCategory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Product_MakeFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Product_FinishedGoodsFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Product_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Product_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Location_CostRate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Location_Availability]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Location_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Illustration_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Document_FolderFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Document_ChangeNumber]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Document_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Document_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_Culture_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_BillOfMaterials_StartDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_BillOfMaterials_PerAssemblyQty]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_BillOfMaterials_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistoryArchive_ReferenceOrderLineID]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistoryArchive_TransactionDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistoryArchive_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistory_ReferenceOrderLineID]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistory_TransactionDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_TransactionHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ScrapReason_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductSubcategory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductSubcategory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductReview_ReviewDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductReview_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductProductPhoto_Primary]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductProductPhoto_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductPhoto_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductModelProductDescriptionCulture_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductModelIllustration_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductModel_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductModel_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_ProductListPriceHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_WorkOrderRouting_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_WorkOrder_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Production].[DF_UnitMeasure_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [dbo].[DF_AWBuildVersion_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [dbo].[DF_ErrorLog_ErrorTime]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_ProductVendor_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderDetail_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_RevisionNumber]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_Status]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_OrderDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_SubTotal]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_TaxAmt]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_Freight]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_PurchaseOrderHeader_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_ShipMethod_ShipBase]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_ShipMethod_ShipRate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_ShipMethod_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_ShipMethod_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_Vendor_PreferredVendorStatus]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_Vendor_ActiveFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Purchasing].[DF_Vendor_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_CountryRegionCurrency_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_CreditCard_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_Currency_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_CurrencyRate_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_PersonCreditCard_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderDetail_UnitPriceDiscount]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderDetail_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderDetail_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_RevisionNumber]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_OrderDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_Status]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_OnlineOrderFlag]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_SubTotal]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_TaxAmt]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_Freight]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeader_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesOrderHeaderSalesReason_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_Bonus]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_CommissionPct]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_SalesYTD]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_SalesLastYear]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPerson_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPersonQuotaHistory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesPersonQuotaHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesReason_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTaxRate_TaxRate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTaxRate_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTaxRate_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_SalesYTD]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_SalesLastYear]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_CostYTD]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_CostLastYear]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritoryHistory_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SalesTerritoryHistory_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_ShoppingCartItem_Quantity]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_ShoppingCartItem_DateCreated]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_ShoppingCartItem_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOffer_DiscountPct]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOffer_MinQty]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOffer_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOffer_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOfferProduct_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_SpecialOfferProduct_ModifiedDate]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_Store_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_Store_ModifiedDate]...';
...
GO
PRINT N'Création de Index de recherche en texte intégral Index de recherche en texte intégral sur [HumanResources].[JobCandidate]...';
...
GO
PRINT N'Création de Index de recherche en texte intégral Index de recherche en texte intégral sur [Production].[Document]...';
...
GO
PRINT N'Création de Index de recherche en texte intégral Index de recherche en texte intégral sur [Production].[ProductReview]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_JobCandidate_Employee_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_EmployeePayHistory_Employee_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_EmployeeDepartmentHistory_Department_DepartmentID]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_EmployeeDepartmentHistory_Employee_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_EmployeeDepartmentHistory_Shift_ShiftID]...';
...
GO
PRINT N'Création de Clé étrangère [HumanResources].[FK_Employee_Person_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_Address_StateProvince_StateProvinceID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_StateProvince_CountryRegion_CountryRegionCode]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_StateProvince_SalesTerritory_TerritoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_PersonPhone_Person_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_PersonPhone_PhoneNumberType_PhoneNumberTypeID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_Person_BusinessEntity_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_Password_Person_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_EmailAddress_Person_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityContact_BusinessEntity_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityContact_ContactType_ContactTypeID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityContact_Person_PersonID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityAddress_Address_AddressID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityAddress_AddressType_AddressTypeID]...';
...
GO
PRINT N'Création de Clé étrangère [Person].[FK_BusinessEntityAddress_BusinessEntity_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductInventory_Location_LocationID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductInventory_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductDocument_Document_DocumentNode]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductDocument_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductCostHistory_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_Product_ProductModel_ProductModelID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_Product_ProductSubcategory_ProductSubcategoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_Product_UnitMeasure_SizeUnitMeasureCode]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_Product_UnitMeasure_WeightUnitMeasureCode]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_Document_Employee_Owner]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_BillOfMaterials_Product_ComponentID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_BillOfMaterials_Product_ProductAssemblyID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_BillOfMaterials_UnitMeasure_UnitMeasureCode]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_TransactionHistory_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductSubcategory_ProductCategory_ProductCategoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductReview_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductProductPhoto_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductProductPhoto_ProductPhoto_ProductPhotoID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductModelProductDescriptionCulture_Culture_CultureID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductModelProductDescriptionCulture_ProductDescription_ProductDescriptionID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductModelProductDescriptionCulture_ProductModel_ProductModelID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductModelIllustration_Illustration_IllustrationID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductModelIllustration_ProductModel_ProductModelID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_ProductListPriceHistory_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_WorkOrderRouting_Location_LocationID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_WorkOrderRouting_WorkOrder_WorkOrderID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_WorkOrder_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Production].[FK_WorkOrder_ScrapReason_ScrapReasonID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_ProductVendor_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_ProductVendor_UnitMeasure_UnitMeasureCode]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_ProductVendor_Vendor_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_PurchaseOrderDetail_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_PurchaseOrderDetail_PurchaseOrderHeader_PurchaseOrderID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_PurchaseOrderHeader_Employee_EmployeeID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_PurchaseOrderHeader_ShipMethod_ShipMethodID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_PurchaseOrderHeader_Vendor_VendorID]...';
...
GO
PRINT N'Création de Clé étrangère [Purchasing].[FK_Vendor_BusinessEntity_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_CountryRegionCurrency_CountryRegion_CountryRegionCode]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_CountryRegionCurrency_Currency_CurrencyCode]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_CurrencyRate_Currency_FromCurrencyCode]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_CurrencyRate_Currency_ToCurrencyCode]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_PersonCreditCard_CreditCard_CreditCardID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_PersonCreditCard_Person_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderDetail_SalesOrderHeader_SalesOrderID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_Address_BillToAddressID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_Address_ShipToAddressID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_CreditCard_CreditCardID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_CurrencyRate_CurrencyRateID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_SalesPerson_SalesPersonID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_SalesTerritory_TerritoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_ShipMethod_ShipMethodID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeaderSalesReason_SalesOrderHeader_SalesOrderID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeaderSalesReason_SalesReason_SalesReasonID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesPerson_Employee_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesPerson_SalesTerritory_TerritoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesPersonQuotaHistory_SalesPerson_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesTaxRate_StateProvince_StateProvinceID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesTerritory_CountryRegion_CountryRegionCode]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesTerritoryHistory_SalesPerson_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesTerritoryHistory_SalesTerritory_TerritoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_ShoppingCartItem_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SpecialOfferProduct_Product_ProductID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SpecialOfferProduct_SpecialOffer_SpecialOfferID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_Store_BusinessEntity_BusinessEntityID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_Store_SalesPerson_SalesPersonID]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_EmployeePayHistory_PayFrequency]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_EmployeePayHistory_Rate]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_EmployeeDepartmentHistory_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_BirthDate]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_Gender]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_HireDate]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_MaritalStatus]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_SickLeaveHours]...';
...
GO
PRINT N'Création de Contrainte de validation [HumanResources].[CK_Employee_VacationHours]...';
...
GO
PRINT N'Création de Contrainte de validation [Person].[CK_Person_EmailPromotion]...';
...
GO
PRINT N'Création de Contrainte de validation [Person].[CK_Person_PersonType]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductInventory_Bin]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductInventory_Shelf]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductCostHistory_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductCostHistory_StandardCost]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_Class]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_DaysToManufacture]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_ListPrice]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_ProductLine]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_ReorderPoint]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_SafetyStockLevel]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_SellEndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_StandardCost]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_Style]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Product_Weight]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Location_Availability]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Location_CostRate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_Document_Status]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_BillOfMaterials_BOMLevel]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_BillOfMaterials_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_BillOfMaterials_PerAssemblyQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_BillOfMaterials_ProductAssemblyID]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_TransactionHistoryArchive_TransactionType]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_TransactionHistory_TransactionType]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductReview_Rating]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductListPriceHistory_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_ProductListPriceHistory_ListPrice]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrderRouting_ActualCost]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrderRouting_ActualEndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrderRouting_ActualResourceHrs]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrderRouting_PlannedCost]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrderRouting_ScheduledEndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrder_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrder_OrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Production].[CK_WorkOrder_ScrappedQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_AverageLeadTime]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_LastReceiptCost]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_MaxOrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_MinOrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_OnOrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ProductVendor_StandardPrice]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderDetail_OrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderDetail_ReceivedQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderDetail_RejectedQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderDetail_UnitPrice]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderHeader_Freight]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderHeader_ShipDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderHeader_Status]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderHeader_SubTotal]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_PurchaseOrderHeader_TaxAmt]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ShipMethod_ShipBase]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_ShipMethod_ShipRate]...';
...
GO
PRINT N'Création de Contrainte de validation [Purchasing].[CK_Vendor_CreditRating]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderDetail_OrderQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderDetail_UnitPrice]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderDetail_UnitPriceDiscount]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_DueDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_Freight]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_ShipDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_Status]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_SubTotal]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesOrderHeader_TaxAmt]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPerson_Bonus]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPerson_CommissionPct]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPerson_SalesLastYear]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPerson_SalesQuota]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPerson_SalesYTD]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesPersonQuotaHistory_SalesQuota]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTaxRate_TaxType]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTerritory_CostLastYear]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTerritory_CostYTD]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTerritory_SalesLastYear]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTerritory_SalesYTD]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SalesTerritoryHistory_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_ShoppingCartItem_Quantity]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SpecialOffer_DiscountPct]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SpecialOffer_EndDate]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SpecialOffer_MaxQty]...';
...
GO
PRINT N'Création de Contrainte de validation [Sales].[CK_SpecialOffer_MinQty]...';
...
GO
PRINT N'Création de Déclencheur [HumanResources].[dEmployee]...';
...
END;
GO
PRINT N'Création de Déclencheur [Person].[iuPerson]...';
...
END;
GO
PRINT N'Création de Vue [HumanResources].[vJobCandidate]...';
...
GO
PRINT N'Création de Vue [HumanResources].[vEmployeeDepartmentHistory]...';
...
GO
PRINT N'Création de Vue [HumanResources].[vEmployeeDepartment]...';
...
GO
PRINT N'Création de Vue [HumanResources].[vEmployee]...';
...
GO
PRINT N'Création de Vue [HumanResources].[vJobCandidateEmployment]...';
...
GO
PRINT N'Création de Vue [HumanResources].[vJobCandidateEducation]...';
...
GO
PRINT N'Création de Vue [Person].[vStateProvinceCountryRegion]...';
...
GO
PRINT N'Création de Index [Person].[vStateProvinceCountryRegion].[IX_vStateProvinceCountryRegion]...';
...
GO
PRINT N'Création de Vue [Person].[vAdditionalContactInfo]...';
...
GO
PRINT N'Création de Vue [Production].[vProductModelInstructions]...';
...
CROSS APPLY [MfgInstructions].ref.nodes('declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions"; 
    step') Steps(ref);
GO
PRINT N'Création de Vue [Production].[vProductModelCatalogDescription]...';
...
GO
PRINT N'Création de Vue [Production].[vProductAndDescription]...';
...
GO
PRINT N'Création de Index [Production].[vProductAndDescription].[IX_vProductAndDescription]...';
...
GO
PRINT N'Création de Vue [Purchasing].[vVendorWithAddresses]...';
...
GO
PRINT N'Création de Vue [Purchasing].[vVendorWithContacts]...';
...
GO
PRINT N'Création de Vue [Sales].[vPersonDemographics]...';
...
GO
PRINT N'Création de Vue [Sales].[vSalesPerson]...';
...
FROM [Sales].[SalesPerson] s
	...
	ON pnt.[PhoneNumberTypeID] = pp.[PhoneNumberTypeID];
GO
PRINT N'Création de Vue [Sales].[vSalesPersonSalesByFiscalYears]...';
...
GO
PRINT N'Création de Vue [Sales].[vStoreWithAddresses]...';
...
FROM [Sales].[Store] s
    ...
    ON at.[AddressTypeID] = bea.[AddressTypeID];
GO
PRINT N'Création de Vue [Sales].[vStoreWithContacts]...';
...
FROM [Sales].[Store] s
	...
	ON pnt.[PhoneNumberTypeID] = pp.[PhoneNumberTypeID];
GO
PRINT N'Création de Vue [Sales].[vStoreWithDemographics]...';
...
FROM [Sales].[Store] s;
GO
PRINT N'Création de Fonction [dbo].[ufnGetAccountingEndDate]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetAccountingStartDate]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetDocumentStatusText]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetProductDealerPrice]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetProductListPrice]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetProductStandardCost]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetPurchaseOrderStatusText]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetSalesOrderStatusText]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnGetStock]...';
...
END;
GO
PRINT N'Création de Fonction [dbo].[ufnLeadingZeros]...';
...
END;
GO
PRINT N'Création de Table [Sales].[Customer]...';
...
GO
PRINT N'Création de Index [Sales].[Customer].[AK_Customer_AccountNumber]...';
...
GO
PRINT N'Création de Index [Sales].[Customer].[AK_Customer_rowguid]...';
...
GO
PRINT N'Création de Index [Sales].[Customer].[IX_Customer_TerritoryID]...';
...
GO
PRINT N'Création de Vue [Sales].[vIndividualCustomer]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_Customer_rowguid]...';
...
GO
PRINT N'Création de Contrainte par défaut [Sales].[DF_Customer_ModifiedDate]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_Customer_Person_PersonID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_Customer_SalesTerritory_TerritoryID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_Customer_Store_StoreID]...';
...
GO
PRINT N'Création de Clé étrangère [Sales].[FK_SalesOrderHeader_Customer_CustomerID]...';
...
GO
PRINT N'Création de Fonction [dbo].[ufnGetContactInformation]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspGetBillOfMaterials]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspGetEmployeeManagers]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspGetManagerEmployees]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspGetWhereUsedProductID]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspPrintError]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspSearchCandidateResumes]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[uspLogError]...';
...
END;
GO
PRINT N'Création de Déclencheur [Production].[iWorkOrder]...';
...
END;
GO
PRINT N'Création de Déclencheur [Production].[uWorkOrder]...';
...
END;
GO
PRINT N'Création de Déclencheur [Purchasing].[iPurchaseOrderDetail]...';
...
END;
GO
PRINT N'Création de Déclencheur [Purchasing].[uPurchaseOrderDetail]...';
...
END;
GO
PRINT N'Création de Déclencheur [Purchasing].[uPurchaseOrderHeader]...';
...
END;
GO
PRINT N'Création de Déclencheur [Purchasing].[dVendor]...';
...
END;
GO
PRINT N'Création de Déclencheur [Sales].[iduSalesOrderDetail]...';
...
END;
GO
PRINT N'Création de Déclencheur [Sales].[uSalesOrderHeader]...';
...
END;
GO
PRINT N'Création de Procédure [HumanResources].[uspUpdateEmployeePersonalInfo]...';
...
END;
GO
PRINT N'Création de Procédure [HumanResources].[uspUpdateEmployeeLogin]...';
...
END;
GO
PRINT N'Création de Procédure [HumanResources].[uspUpdateEmployeeHireInfo]...';
...
END;
GO
PRINT N'Création de Propriété étendue [MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [PRIMARY].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[ShiftID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[StartTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[EndTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Shift_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_Shift_ShiftID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[AK_Shift_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Shift].[AK_Shift_StartTime_EndTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[JobCandidateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[Resume].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_JobCandidate_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_JobCandidate_JobCandidateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_JobCandidate_Employee_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[JobCandidate].[IX_JobCandidate_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[RateChangeDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[Rate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[PayFrequency].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeePayHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_EmployeePayHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_EmployeePayHistory_BusinessEntityID_RateChangeDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_EmployeePayHistory_PayFrequency].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_EmployeePayHistory_Rate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_EmployeePayHistory_Employee_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[ShiftID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_EmployeeDepartmentHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_EmployeeDepartmentHistory_BusinessEntityID_StartDate_DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_EmployeeDepartmentHistory_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_EmployeeDepartmentHistory_Department_DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_EmployeeDepartmentHistory_Employee_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_EmployeeDepartmentHistory_Shift_ShiftID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[IX_EmployeeDepartmentHistory_DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[EmployeeDepartmentHistory].[IX_EmployeeDepartmentHistory_ShiftID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[NationalIDNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[LoginID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[OrganizationNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[OrganizationLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[JobTitle].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[BirthDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[MaritalStatus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[Gender].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[HireDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[SalariedFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[VacationHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[SickLeaveHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[CurrentFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_SalariedFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_VacationHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_SickLeaveHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_CurrentFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Employee_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_Employee_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_BirthDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_Gender].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_HireDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_MaritalStatus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_SickLeaveHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[CK_Employee_VacationHours].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[FK_Employee_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[AK_Employee_LoginID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[AK_Employee_NationalIDNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[AK_Employee_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[IX_Employee_OrganizationLevel_OrganizationNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Employee].[IX_Employee_OrganizationNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[dEmployee].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[GroupName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[DF_Department_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[PK_Department_DepartmentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[Department].[AK_Department_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vJobCandidate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vEmployeeDepartmentHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vEmployeeDepartment].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vEmployee].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vJobCandidateEmployment].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[vJobCandidateEducation].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[@BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[@NationalIDNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[@BirthDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[@MaritalStatus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeePersonalInfo].[@Gender].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@OrganizationNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@LoginID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@JobTitle].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@HireDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeLogin].[@CurrentFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@JobTitle].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@HireDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@RateChangeDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@Rate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@PayFrequency].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[uspUpdateEmployeeHireInfo].[@CurrentFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [HumanResources].[HRResumeSchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_AddressType_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_AddressType_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_AddressType_AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[AK_AddressType_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AddressType].[AK_AddressType_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[AddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[AddressLine1].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[AddressLine2].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[City].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[PostalCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[SpatialLocation].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Address_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Address_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_Address_AddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_Address_StateProvince_StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[AK_Address_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Address].[IX_Address_StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[StateProvinceCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[IsOnlyStateProvinceFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_StateProvince_IsOnlyStateProvinceFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_StateProvince_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_StateProvince_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_StateProvince_StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_StateProvince_CountryRegion_CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_StateProvince_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[AK_StateProvince_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[AK_StateProvince_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[StateProvince].[AK_StateProvince_StateProvinceCode_CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PhoneNumberType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PhoneNumberType].[PhoneNumberTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PhoneNumberType].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PhoneNumberType].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_PhoneNumberType_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_PhoneNumberType_PhoneNumberTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[PhoneNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[PhoneNumberTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_PersonPhone_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_PersonPhone_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_PersonPhone_PhoneNumberType_PhoneNumberTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PersonPhone].[IX_PersonPhone_PhoneNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[PersonType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[NameStyle].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[Title].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[FirstName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[MiddleName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[LastName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[Suffix].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[EmailPromotion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[AdditionalContactInfo].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Person_NameStyle].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Person_EmailPromotion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Person_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Person_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CK_Person_EmailPromotion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CK_Person_PersonType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_Person_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[AK_Person_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[PXML_Person_AddContact].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[PXML_Person_Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[XMLPATH_Person_Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[XMLPROPERTY_Person_Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Person].[XMLVALUE_Person_Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[iuPerson].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Password].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Password].[PasswordHash].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Password].[PasswordSalt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Password].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[Password].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Password_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_Password_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_Password_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_Password_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[EmailAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[EmailAddress].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_EmailAddress_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_EmailAddress_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_EmailAddress_BusinessEntityID_EmailAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_EmailAddress_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[EmailAddress].[IX_EmailAddress_EmailAddress].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CountryRegion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CountryRegion].[CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CountryRegion].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CountryRegion].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_CountryRegion_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_CountryRegion_CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[CountryRegion].[AK_CountryRegion_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[ContactType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[ContactType].[ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[ContactType].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[ContactType].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_ContactType_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_ContactType_ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[ContactType].[AK_ContactType_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntityContact_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntityContact_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_BusinessEntityContact_BusinessEntityID_PersonID_ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityContact_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityContact_ContactType_ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityContact_Person_PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[AK_BusinessEntityContact_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[IX_BusinessEntityContact_ContactTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityContact].[IX_BusinessEntityContact_PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[AddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntityAddress_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntityAddress_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityAddress_Address_AddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityAddress_AddressType_AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[FK_BusinessEntityAddress_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[AK_BusinessEntityAddress_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[IX_BusinessEntityAddress_AddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntityAddress].[IX_BusinessEntityAddress_AddressTypeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntity].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntity].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntity].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntity_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[DF_BusinessEntity_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[PK_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[BusinessEntity].[AK_BusinessEntity_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[vStateProvinceCountryRegion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[vStateProvinceCountryRegion].[IX_vStateProvinceCountryRegion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[vAdditionalContactInfo].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[IndividualSurveySchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Person].[AdditionalContactInfoSchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[Shelf].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[Bin].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductInventory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductInventory_Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductInventory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductInventory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductInventory_ProductID_LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductInventory_Bin].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductInventory_Shelf].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductInventory_Location_LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductInventory_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDocument].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDocument].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDocument].[DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDocument].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductDocument_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductDocument_ProductID_DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductDocument_Document_DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductDocument_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[ProductDescriptionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[Description].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductDescription_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductDescription_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductDescription_ProductDescriptionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescription].[AK_ProductDescription_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[StandardCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCostHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductCostHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductCostHistory_ProductID_StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductCostHistory_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductCostHistory_StandardCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductCostHistory_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[ProductCategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductCategory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductCategory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductCategory_ProductCategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[AK_ProductCategory_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductCategory].[AK_ProductCategory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ProductNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[MakeFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[FinishedGoodsFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Color].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[SafetyStockLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ReorderPoint].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[StandardCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ListPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Size].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[SizeUnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[WeightUnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Weight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[DaysToManufacture].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ProductLine].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Class].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[Style].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ProductSubcategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[SellStartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[SellEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[DiscontinuedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Product_MakeFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Product_FinishedGoodsFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Product_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Product_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_Class].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_DaysToManufacture].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_ListPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_ProductLine].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_ReorderPoint].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_SafetyStockLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_SellEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_StandardCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_Style].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Product_Weight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_Product_ProductModel_ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_Product_ProductSubcategory_ProductSubcategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_Product_UnitMeasure_SizeUnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_Product_UnitMeasure_WeightUnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[AK_Product_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[AK_Product_ProductNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Product].[AK_Product_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[CostRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[Availability].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Location_CostRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Location_Availability].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Location_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_Location_LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Location_Availability].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Location_CostRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Location].[AK_Location_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Illustration].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Illustration].[IllustrationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Illustration].[Diagram].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Illustration].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Illustration_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_Illustration_IllustrationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[DocumentLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[Title].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[Owner].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[FolderFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[FileName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[FileExtension].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[Revision].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[ChangeNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[DocumentSummary].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[Document].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Document_ChangeNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Document_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Document_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_Document_DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_Document_Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_Document_Employee_Owner].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[AK_Document_DocumentLevel_DocumentNode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[AK_Document_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Document].[IX_Document_FileName_Revision].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Culture].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Culture].[CultureID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Culture].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Culture].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_Culture_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_Culture_CultureID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[Culture].[AK_Culture_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[BillOfMaterialsID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[ProductAssemblyID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[ComponentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[BOMLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[PerAssemblyQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_BillOfMaterials_StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_BillOfMaterials_PerAssemblyQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_BillOfMaterials_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_BillOfMaterials_BillOfMaterialsID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_BillOfMaterials_BOMLevel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_BillOfMaterials_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_BillOfMaterials_PerAssemblyQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_BillOfMaterials_ProductAssemblyID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_BillOfMaterials_Product_ComponentID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_BillOfMaterials_Product_ProductAssemblyID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_BillOfMaterials_UnitMeasure_UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[BillOfMaterials].[IX_BillOfMaterials_UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[TransactionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[ReferenceOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[TransactionDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[TransactionType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[ActualCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistoryArchive_ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistoryArchive_TransactionDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistoryArchive_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_TransactionHistoryArchive_TransactionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_TransactionHistoryArchive_TransactionType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[IX_TransactionHistoryArchive_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistoryArchive].[IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[TransactionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[ReferenceOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[TransactionDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[TransactionType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[ActualCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistory_ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistory_TransactionDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_TransactionHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_TransactionHistory_TransactionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_TransactionHistory_TransactionType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_TransactionHistory_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[IX_TransactionHistory_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[TransactionHistory].[IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ScrapReason].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ScrapReason].[ScrapReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ScrapReason].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ScrapReason].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ScrapReason_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ScrapReason_ScrapReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ScrapReason].[AK_ScrapReason_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[ProductSubcategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[ProductCategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductSubcategory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductSubcategory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductSubcategory_ProductSubcategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductSubcategory_ProductCategory_ProductCategoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[AK_ProductSubcategory_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductSubcategory].[AK_ProductSubcategory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[ProductReviewID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[ReviewerName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[ReviewDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[EmailAddress].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[Rating].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[Comments].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductReview_ReviewDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductReview_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductReview_ProductReviewID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductReview_Rating].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductReview_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductReview].[IX_ProductReview_ProductID_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductProductPhoto].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductProductPhoto].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductProductPhoto].[ProductPhotoID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductProductPhoto].[Primary].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductProductPhoto].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductProductPhoto_Primary].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductProductPhoto_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductProductPhoto_ProductID_ProductPhotoID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductProductPhoto_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductProductPhoto_ProductPhoto_ProductPhotoID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[ProductPhotoID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[ThumbNailPhoto].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[ThumbnailPhotoFileName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[LargePhoto].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[LargePhotoFileName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductPhoto].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductPhoto_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductPhoto_ProductPhotoID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelProductDescriptionCulture].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelProductDescriptionCulture].[ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelProductDescriptionCulture].[ProductDescriptionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelProductDescriptionCulture].[CultureID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelProductDescriptionCulture].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductModelProductDescriptionCulture_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductModelProductDescriptionCulture_ProductModelID_ProductDescriptionID_CultureID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductModelProductDescriptionCulture_Culture_CultureID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductModelProductDescriptionCulture_ProductDescription_ProductDescriptionID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductModelProductDescriptionCulture_ProductModel_ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelIllustration].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelIllustration].[ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelIllustration].[IllustrationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModelIllustration].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductModelIllustration_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductModelIllustration_ProductModelID_IllustrationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductModelIllustration_Illustration_IllustrationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductModelIllustration_ProductModel_ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[CatalogDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[Instructions].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductModel_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductModel_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductModel_ProductModelID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[AK_ProductModel_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[AK_ProductModel_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[PXML_ProductModel_CatalogDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductModel].[PXML_ProductModel_Instructions].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[ListPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductListPriceHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_ProductListPriceHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_ProductListPriceHistory_ProductID_StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductListPriceHistory_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_ProductListPriceHistory_ListPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_ProductListPriceHistory_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[WorkOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[OperationSequence].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ScheduledStartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ScheduledEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ActualStartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ActualEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ActualResourceHrs].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[PlannedCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ActualCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_WorkOrderRouting_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrderRouting_ActualCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrderRouting_ActualEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrderRouting_ActualResourceHrs].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrderRouting_PlannedCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrderRouting_ScheduledEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_WorkOrderRouting_Location_LocationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_WorkOrderRouting_WorkOrder_WorkOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrderRouting].[IX_WorkOrderRouting_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[WorkOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[StockedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[ScrappedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[DueDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[ScrapReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_WorkOrder_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_WorkOrder_WorkOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrder_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrder_OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[CK_WorkOrder_ScrappedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_WorkOrder_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[FK_WorkOrder_ScrapReason_ScrapReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[IX_WorkOrder_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[WorkOrder].[IX_WorkOrder_ScrapReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[iWorkOrder].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[uWorkOrder].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[UnitMeasure].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[UnitMeasure].[UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[UnitMeasure].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[UnitMeasure].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[DF_UnitMeasure_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[PK_UnitMeasure_UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[UnitMeasure].[AK_UnitMeasure_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[vProductModelInstructions].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[vProductModelCatalogDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[vProductAndDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[vProductAndDescription].[IX_vProductAndDescription].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ProductDescriptionSchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Production].[ManuInstructionsSchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetContactInformation].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetContactInformation].[@PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetBillOfMaterials].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetBillOfMaterials].[@StartProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetBillOfMaterials].[@CheckDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetEmployeeManagers].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetEmployeeManagers].[@BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetManagerEmployees].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetManagerEmployees].[@BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetWhereUsedProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetWhereUsedProductID].[@StartProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspGetWhereUsedProductID].[@CheckDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspLogError].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspLogError].[@ErrorLogID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[uspPrintError].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetAccountingEndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetAccountingStartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetDocumentStatusText].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetDocumentStatusText].[@Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductDealerPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductDealerPrice].[@ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductDealerPrice].[@OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductListPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductListPrice].[@ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductListPrice].[@OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductStandardCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductStandardCost].[@ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetProductStandardCost].[@OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetPurchaseOrderStatusText].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetPurchaseOrderStatusText].[@Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetSalesOrderStatusText].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetSalesOrderStatusText].[@Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetStock].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnGetStock].[@ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnLeadingZeros].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ufnLeadingZeros].[@Value].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[AWBuildVersion].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[AWBuildVersion].[SystemInformationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[AWBuildVersion].[Database Version].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[AWBuildVersion].[VersionDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[AWBuildVersion].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DF_AWBuildVersion_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[PK_AWBuildVersion_SystemInformationID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[DatabaseLogID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[PostTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[DatabaseUser].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[Event].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[Schema].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[Object].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[TSQL].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DatabaseLog].[XmlEvent].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[PK_DatabaseLog_DatabaseLogID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorLogID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[UserName].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorSeverity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorState].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorProcedure].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorLine].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[ErrorLog].[ErrorMessage].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[DF_ErrorLog_ErrorTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [dbo].[PK_ErrorLog_ErrorLogID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[AverageLeadTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[StandardPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[LastReceiptCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[LastReceiptDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[MinOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[MaxOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[OnOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_ProductVendor_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PK_ProductVendor_ProductID_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_AverageLeadTime].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_LastReceiptCost].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_MaxOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_MinOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_OnOrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ProductVendor_StandardPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_ProductVendor_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_ProductVendor_UnitMeasure_UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_ProductVendor_Vendor_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[IX_ProductVendor_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ProductVendor].[IX_ProductVendor_UnitMeasureCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[PurchaseOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[PurchaseOrderDetailID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[DueDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[UnitPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[LineTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[ReceivedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[RejectedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[StockedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderDetail_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderDetail_OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderDetail_ReceivedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderDetail_RejectedQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderDetail_UnitPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_PurchaseOrderDetail_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_PurchaseOrderDetail_PurchaseOrderHeader_PurchaseOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderDetail].[IX_PurchaseOrderDetail_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[iPurchaseOrderDetail].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[uPurchaseOrderDetail].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[PurchaseOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[RevisionNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[EmployeeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[VendorID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[ShipDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[TotalDue].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_RevisionNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_PurchaseOrderHeader_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PK_PurchaseOrderHeader_PurchaseOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderHeader_Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderHeader_ShipDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderHeader_Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderHeader_SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_PurchaseOrderHeader_TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_PurchaseOrderHeader_Employee_EmployeeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_PurchaseOrderHeader_ShipMethod_ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_PurchaseOrderHeader_Vendor_VendorID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[IX_PurchaseOrderHeader_EmployeeID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PurchaseOrderHeader].[IX_PurchaseOrderHeader_VendorID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[uPurchaseOrderHeader].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[ShipBase].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[ShipRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_ShipMethod_ShipBase].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_ShipMethod_ShipRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_ShipMethod_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_ShipMethod_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PK_ShipMethod_ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ShipMethod_ShipBase].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_ShipMethod_ShipRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[AK_ShipMethod_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[ShipMethod].[AK_ShipMethod_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[AccountNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[CreditRating].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[PreferredVendorStatus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[ActiveFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[PurchasingWebServiceURL].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_Vendor_PreferredVendorStatus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_Vendor_ActiveFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[DF_Vendor_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[PK_Vendor_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[CK_Vendor_CreditRating].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[FK_Vendor_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[Vendor].[AK_Vendor_AccountNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[dVendor].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[vVendorWithAddresses].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Purchasing].[vVendorWithContacts].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CountryRegionCurrency].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CountryRegionCurrency].[CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CountryRegionCurrency].[CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CountryRegionCurrency].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_CountryRegionCurrency_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_CountryRegionCurrency_CountryRegion_CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_CountryRegionCurrency_Currency_CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CountryRegionCurrency].[IX_CountryRegionCurrency_CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[CardType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[CardNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[ExpMonth].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[ExpYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_CreditCard_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_CreditCard_CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CreditCard].[AK_CreditCard_CardNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Currency].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Currency].[CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Currency].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Currency].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_Currency_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_Currency_CurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Currency].[AK_Currency_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[CurrencyRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[CurrencyRateDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[FromCurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[ToCurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[AverageRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[EndOfDayRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_CurrencyRate_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_CurrencyRate_CurrencyRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_CurrencyRate_Currency_FromCurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_CurrencyRate_Currency_ToCurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CurrencyRate].[AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[CustomerID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[StoreID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[AccountNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_Customer_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_Customer_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_Customer_CustomerID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_Customer_Person_PersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_Customer_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_Customer_Store_StoreID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[AK_Customer_AccountNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[AK_Customer_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Customer].[IX_Customer_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PersonCreditCard].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PersonCreditCard].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PersonCreditCard].[CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PersonCreditCard].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_PersonCreditCard_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_PersonCreditCard_BusinessEntityID_CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_PersonCreditCard_CreditCard_CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_PersonCreditCard_Person_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[SalesOrderDetailID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[CarrierTrackingNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[SpecialOfferID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[UnitPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[UnitPriceDiscount].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[LineTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderDetail_UnitPriceDiscount].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderDetail_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderDetail_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderDetail_OrderQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderDetail_UnitPrice].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderDetail_UnitPriceDiscount].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderDetail_SalesOrderHeader_SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[AK_SalesOrderDetail_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderDetail].[IX_SalesOrderDetail_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[iduSalesOrderDetail].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[RevisionNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[DueDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[ShipDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[OnlineOrderFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[SalesOrderNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[PurchaseOrderNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[AccountNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[CustomerID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[BillToAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[ShipToAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[CreditCardApprovalCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[CurrencyRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[TotalDue].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[Comment].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_RevisionNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_OrderDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_OnlineOrderFlag].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeader_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesOrderHeader_SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_DueDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_Freight].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_ShipDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_Status].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_SubTotal].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesOrderHeader_TaxAmt].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_Address_BillToAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_Address_ShipToAddressID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_CreditCard_CreditCardID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_CurrencyRate_CurrencyRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_Customer_CustomerID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_SalesPerson_SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeader_ShipMethod_ShipMethodID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[AK_SalesOrderHeader_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[AK_SalesOrderHeader_SalesOrderNumber].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[IX_SalesOrderHeader_CustomerID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeader].[IX_SalesOrderHeader_SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[uSalesOrderHeader].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeaderSalesReason].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeaderSalesReason].[SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeaderSalesReason].[SalesReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesOrderHeaderSalesReason].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesOrderHeaderSalesReason_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeaderSalesReason_SalesOrderHeader_SalesOrderID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesOrderHeaderSalesReason_SalesReason_SalesReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[SalesQuota].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[Bonus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[CommissionPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_Bonus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_CommissionPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPerson_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesPerson_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPerson_Bonus].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPerson_CommissionPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPerson_SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPerson_SalesQuota].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPerson_SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesPerson_Employee_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesPerson_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPerson].[AK_SalesPerson_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[QuotaDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[SalesQuota].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPersonQuotaHistory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesPersonQuotaHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesPersonQuotaHistory_SalesQuota].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesPersonQuotaHistory_SalesPerson_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesPersonQuotaHistory].[AK_SalesPersonQuotaHistory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesReason].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesReason].[SalesReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesReason].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesReason].[ReasonType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesReason].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesReason_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesReason_SalesReasonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[SalesTaxRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[TaxType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[TaxRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTaxRate_TaxRate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTaxRate_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTaxRate_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesTaxRate_SalesTaxRateID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTaxRate_TaxType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesTaxRate_StateProvince_StateProvinceID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[AK_SalesTaxRate_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTaxRate].[AK_SalesTaxRate_StateProvinceID_TaxType].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[Group].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[CostYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[CostLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_CostYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_CostLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTerritory_CostLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTerritory_CostYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTerritory_SalesLastYear].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTerritory_SalesYTD].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesTerritory_CountryRegion_CountryRegionCode].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[AK_SalesTerritory_Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritory].[AK_SalesTerritory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritoryHistory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SalesTerritoryHistory_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SalesTerritoryHistory_BusinessEntityID_StartDate_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SalesTerritoryHistory_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesTerritoryHistory_SalesPerson_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SalesTerritoryHistory_SalesTerritory_TerritoryID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SalesTerritoryHistory].[AK_SalesTerritoryHistory_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[ShoppingCartItemID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[ShoppingCartID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[DateCreated].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_ShoppingCartItem_Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_ShoppingCartItem_DateCreated].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_ShoppingCartItem_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_ShoppingCartItem_ShoppingCartItemID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_ShoppingCartItem_Quantity].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_ShoppingCartItem_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[ShoppingCartItem].[IX_ShoppingCartItem_ShoppingCartID_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[SpecialOfferID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[Description].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[DiscountPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[Type].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[Category].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[StartDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[MinQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[MaxQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOffer_DiscountPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOffer_MinQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOffer_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOffer_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SpecialOffer_SpecialOfferID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SpecialOffer_DiscountPct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SpecialOffer_EndDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SpecialOffer_MaxQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[CK_SpecialOffer_MinQty].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOffer].[AK_SpecialOffer_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[SpecialOfferID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOfferProduct_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_SpecialOfferProduct_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_SpecialOfferProduct_SpecialOfferID_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SpecialOfferProduct_Product_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_SpecialOfferProduct_SpecialOffer_SpecialOfferID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[AK_SpecialOfferProduct_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[SpecialOfferProduct].[IX_SpecialOfferProduct_ProductID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[Name].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_Store_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[DF_Store_ModifiedDate].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[PK_Store_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_Store_BusinessEntity_BusinessEntityID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[FK_Store_SalesPerson_SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[AK_Store_rowguid].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[IX_Store_SalesPersonID].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[Store].[PXML_Store_Demographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vIndividualCustomer].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vPersonDemographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vSalesPerson].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vSalesPersonSalesByFiscalYears].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vStoreWithAddresses].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vStoreWithContacts].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[vStoreWithDemographics].[MS_Description]...';
...
GO
PRINT N'Création de Propriété étendue [Sales].[StoreSurveySchemaCollection].[MS_Description]...';
...
GO
PRINT N'Création de Déclencheur [ddlDatabaseTriggerLog]...';
...
GO
PRINT N'Création de Propriété étendue [ddlDatabaseTriggerLog].[MS_Description]...';
